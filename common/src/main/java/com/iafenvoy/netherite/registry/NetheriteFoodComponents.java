...
public final class NetheriteFoodComponents {
    public static final FoodComponent NETHERITE_APPLE = new FoodComponent.Builder().hunger(8).saturationModifier(2.4F)
            ...
            .alwaysEdible().build();
    public static final FoodComponent NETHERITE_CARROT = new FoodComponent.Builder().hunger(4).saturationModifier(1.2F)
