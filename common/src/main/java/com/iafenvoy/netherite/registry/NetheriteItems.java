...
public final class NetheriteItems {
    ...
    public static final RegistrySupplier<Item> NETHERITE_BOW = register(new Identifier(NetheriteExtension.MOD_ID, "netherite_bow"), () -> new NetheriteBowItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.bow).fireproof()));
    public static final RegistrySupplier<Item> NETHERITE_CROSSBOW = register(new Identifier(NetheriteExtension.MOD_ID, "netherite_crossbow"), () -> new CrossbowItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.crossbow).fireproof()));
    public static final RegistrySupplier<Item> NETHERITE_TRIDENT = register(new Identifier(NetheriteExtension.MOD_ID, "netherite_trident"), () -> new NetheriteTridentItem(new Item.Settings().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.trident).fireproof()));
    ...
    public static final RegistrySupplier<Item> NETHERITE_SHIELD = register(new Identifier(NetheriteExtension.MOD_ID, "netherite_shield"), () -> NetheriteShieldItem.create(new Item.Settings().fireproof().maxDamage(NetheriteExtensionConfig.INSTANCE.durability.shield)));
